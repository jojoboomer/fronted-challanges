...
import { btnClear, cart as cartStyle } from "@styles/cart";
...
function Cart() {
  const { cart, total, count, removeItem } = useCartStore();
  ...
  return (
    <>
      <div className={cartStyle}>
        <h2>
          Your Cart (<span id="itemsOnCart">{count}</span>)
        </h2>
        <ul className="cart-container" id="cart">
          {cart.length != 0 &&
            cart.map((e, i) => (
              <>
                <li key={i}>
                  <div className="item-body">
                    ...
                    <div>
                      ...
                      <span
                        className={css({ marginLeft: "8px", color: "#ad8985" })}
                      >
                        @ ${e.price.toFixed(2)}
                      </span>
                      <span
                  ...
                  >
                    <svg
                      ...
                      viewBox="0 0 10 10"
                    >
                      <path d="M8.375 9.375 5 6 1.625 9.375l-1-1L4 5 .625 1.625l1-1L5 4 8.375.625l1 1L6 5l3.375 3.375-1 1Z"></path>
                    </svg>
                  </button>
                </li>
        ...
        {cart.length != 0 && (
          <div className="cart-footer">
            ...
            <div>
              <button className={btnClear} onClick={openModal}>
                Confirm Order
              </button>
            </div>
          </div>
